...
// Company master definitions with WCAG AA compliant badge text colors
const COMPANIES = [
...
const COMPANY_MAP = COMPANIES.reduce((acc, c) => ({ ...acc, [c.code]: c }), {});

/* ==============================================================================
 * SECTION 3: HELPERS (Defined ONCE as required)
 * ============================================================================== */
 ...
 */
function formatSpreadsheetDate(v) {
 ...
 */
function matchesCompany(str, code) {
  if (!str) return false;
 ...
 */
function getCompanyCode(carrierName) {
 ...
 */
function calculateSafeTenureDays(hireDateStr, termDateStr, status, asOfDateStr) {
